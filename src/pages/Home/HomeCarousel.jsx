    ...
    <div>
      ...
      <div className="mt-4">
        <div className="text-center font-bold text-3xl p-3">
          {" "}
          Find <span className="italic text-red-500 text-4xl">Your Car...</span>
        </div>
        <div className=" flex justify-center flex-wrap rounded-box  container mx-auto">
          <div className="carousel-item mx-2 hover:scale-105">
            <div data-aos="fade-right">
              <Link to={`/catagory/1`}>
                {" "}
                <img
                  src="https://m.media-amazon.com/images/I/81Bx9T8G65L.jpg"
                  alt="Drink"
          ...
          <div
            className="carousel-item mx-2 hover:scale-105"
            data-aos="flip-left"
          >
            <Link to={`/catagory/2`}>
              {" "}
